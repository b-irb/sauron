...
#define CR0_EMULATE_FPU(_) (((_) >> 2) & 0x01)
         ...
         * are clear, an \#NM exception is not raised prior to the execution of
         * an x87 FPU WAIT/FWAIT instruction.
         ...
         * exception of the instructions listed above). The fault handler for
         * the \#NM exception can then be used to clear the TS flag (with the
         * CLTS instruction) and save the context of the x87 FPU, XMM, and MXCSR
         * registers. If the task never encounters an x87
...
typedef union {
    struct {
         ...
         * virtual-8086 mode when set; disables the extensions when clear. Use
         * of the virtual mode extensions can improve the performance of
         * virtual-8086 applications by eliminating the overhead of calling the
         * virtual- 8086 monitor to handle interrupts and exceptions that occur
         * while executing an 8086 program and, instead, redirecting the
         * interrupts and exceptions back to the 8086 program's handlers. It
         * also provides hardware support for a virtual interrupt flag (VIF) to
         * improve reliability of running 8086 programs in multitasking and
...
#define CR4_VIRTUAL_MODE_EXTENSIONS(_) (((_) >> 0) & 0x01)
         ...
         * in protected mode when set; disables the VIF flag in protected mode
         * when clear.
         *
...
#define CR4_PROTECTED_MODE_VIRTUAL_INTERRUPTS(_) (((_) >> 1) & 0x01)
         ...
         * procedures running at privilege level 0 when set; allows RDTSC
         * instruction to be executed at any privilege level when clear. This
         * bit also applies to the RDTSCP instruction if supported (if
...
#define CR4_PAGE_SIZE_EXTENSIONS(_) (((_) >> 4) & 0x01)
         ...
         * more than 32 bits. When clear, restricts physical addresses to 32
...
#define CR4_MACHINE_CHECK_ENABLE(_) (((_) >> 6) & 0x01)
         ...
         * page feature when set; disables the global page feature when clear.
         * The global page feature allows frequently used or shared pages to be
         ...
         * write to register CR3. When enabling the global page feature, paging
         * must be enabled (by setting the PG flag in control register CR0)
         * before the PGE flag is set. Reversing this sequence may affect
...
#define CR4_PERFORMANCE_MONITORING_COUNTER_ENABLE(_) (((_) >> 8) & 0x01)
         ...
         * the contents of the XMM and MXCSR registers along with the contents
         * of the x87 FPU and MMX registers, and
         * -# enables the processor to execute SSE/SSE2/SSE3/SSSE3/SSE4
         * instructions, with the exception of the PAUSE, PREFETCHh, SFENCE,
         * LFENCE, MFENCE, MOVNTI, CLFLUSH, CRC32, and POPCNT. If this flag is
         * clear, the FXSAVE and FXRSTOR instructions will save and restore the
         * contents of the x87 FPU and MMX registers, but they may not save and
         * restore the contents of the XMM and MXCSR registers. Also, the
         * processor will generate an invalid opcode exception (\#UD) if it
         * attempts to execute any SSE/SSE2/SSE3 instruction, with the exception
         * of PAUSE, PREFETCHh, SFENCE, LFENCE, MFENCE, MOVNTI, CLFLUSH, CRC32,
         * and POPCNT. The operating system or executive must explicitly set
         * this flag.
         *
         ...
         * contents of the X87 FPU, XMM and MXCSR registers. Consequently OSFXSR
         * bit indicates that the operating system provides context switch
         * support for SSE/SSE2/SSE3/SSSE3/SSE4.
         */
...
#define CR4_OS_FXSAVE_FXRSTOR_SUPPORT(_) (((_) >> 9) & 0x01)
         ...
         * Exceptions - When set, indicates that the operating system supports
         * the handling of unmasked SIMD floating-point exceptions through an
         * exception handler that is invoked when a SIMD floating-point
         * exception (\#XM) is generated. SIMD floating-point exceptions are
         * only generated by SSE/SSE2/SSE3/SSE4.1 SIMD floatingpoint
         * instructions. The operating system or executive must explicitly set
         * this flag. If this flag is not set, the processor will generate an
...
#define CR4_OS_XMM_EXCEPTION_SUPPORT(_) (((_) >> 10) & 0x01)
         ...
         * CPL > 0: SGDT, SIDT, SLDT, SMSW, and STR. An attempt at such
...
#define CR4_PCID_ENABLE(_) (((_) >> 17) & 0x01)
         ...
         * x87 FPU state (including MMX registers), the SSE state (XMM registers
         * and MXCSR), along with other processor extended states enabled in
         * XCR0;
...
#define CR4_SMAP_ENABLE(_) (((_) >> 21) & 0x01)
         ...
         * a protection key. The PKRU register specifies, for each protection
...
#define CPUID_EAX_MAX_ADDRESSABLE_IDS_FOR_LOGICAL_PROCESSORS_SHARING_THIS_CACHE( \
    ...
    (((_) >> 14) & 0xFFF)
             ...
             * Core ID is a subset of bits of the initial APIC ID. The returned
             * value is constant for valid initial values in ECX. Valid ECX
             * values start from 0.
             */
...
#define CPUID_ECX_HARDWARE_COORDINATION_FEEDBACK_CAPABILITY(_) \
    (((_) >> 0) & 0x01)
            ...
            /**
             * [Bit 3] The processor supports performance-energy bias preference
             * if CPUID.06H:ECX.SETBH[bit 3] is set and it also implies the
             * presence of a new architectural MSR called IA32_ENERGY_PERF_BIAS
             * (1B0H).
             */
            u32 performance_energy_bias_preference : 1;
...
#define CPUID_EAX_IA32_PLATFORM_DCA_CAP(_) (((_) >> 0) & 0xFFFFFFFF)
    ...
    union {
        struct {
             ...
             * area.
             * This field reports 0 if the sub-leaf index, n, does not map to a
             * valid bit in the XCR0 register.
             */
            u32 reserved : 32;
#define CPUID_EBX_RESERVED_BIT 0
#define CPUID_EBX_RESERVED_FLAG 0xFFFFFFFF
...
#define IA32_VMX_PROCBASED_CTLS2_ENABLE_PML(_) (((_) >> 17) & 0x01)
         ...
         * virtualization exceptions (\#VE) instead of VM exits.
         *
...
typedef union {
    struct {
         ...
         * non-zero will not cause a \#GP, but an operational error will be
         * signaled once TraceEn is set.
         *
...
#define IA32_RTIT_CTL_USER(_) (((_) >> 3) & 0x01)
         ...
         */
        u64 power_event_trace_enabled : 1;
...
#define IA32_RTIT_CTL_TSC_ENABLED(_) (((_) >> 10) & 0x01)
         ...
         */
        u64 ret_compression_disabled : 1;
...
#define VMX_EXIT_QUALIFICATION_LMSW_OP_MEMORY 0x00000001
         ...
         */
        u64 general_purpose_register : 4;
...
#define VMX_EXIT_QUALIFICATION_EPT_VIOLATION_EPT_EXECUTABLE(_) \
    (((_) >> 5) & 0x01)
         ...
         */
        u64 ept_executable_for_user_mode : 1;
...
#define VMX_VMEXIT_INSTRUCTION_INFO_INVALIDATE_GENERAL_PURPOSE_REGISTER(_) \
    (((_) >> 18) & 0x0F)
         ...
         */
        u64 general_purpose_register_invalid : 1;
